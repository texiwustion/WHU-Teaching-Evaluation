...
function createFloatingButton(props) {
  ...
  button.addEventListener('mousemove', (event)=>changeCursorOnButton(event, props));
  // Make the button draggable
  button.onmousedown = (event)=>dragButton(event, props);
...
function changeCursorOnButton(event, props) {
  //防止移动过程中出事
...
function dragButton(event, props) {
